...
# oliversmith.io/mqtt-broker-operator-bundle:$VERSION and oliversmith.io/mqtt-broker-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= oliversmith.io/mqtt-broker-operator
